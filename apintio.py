...
class APIntIO_SHA256:

    def __init__(self, password, auto_launch_wifi: bool):
        self.password = password
        
        # Using adafruit_hashlib to create the SHA-256 hash
        self.password_hash = adafruit_hashlib.sha256(self.password.encode()).digest()
